...
export const dashboardPhotos = [
  ...
  unsplash('1594381898411-846e7d193883'),
  unsplash('1571731956672-f2b94d7dd0cb'),
]

export const exercisePhotos = [
  unsplash('1574680178050-55c6a6a96e0a'),
  unsplash('1571019613454-1cb2f99b2d8b'),
  unsplash('1594381898411-846e7d193883'),
]

export const calendarPhotos = [
  unsplash('1584863265045-f9d10ca7fa61'),
  unsplash('1574680088814-c9e8a10d8a4d'),
  unsplash('1571731956672-f2b94d7dd0cb'),
]

export const gymsPhotos = [
  unsplash('1571019613454-1cb2f99b2d8b'),
  unsplash('1546483875-ad9014c88eba'),
  unsplash('1609899517237-77d357b047cf'),
]
